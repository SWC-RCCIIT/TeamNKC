...
<?php include_once('rightsidebar.php')?>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content" class="mt-4 pt-4 dashboard_body">
		...
		<div class="col-xl-6 ">
			<div>
			<div class="text-s font-weight-bold text-danger text-uppercase mb-1">Welcome Back <?php echo $_SESSION['name']?></div>
			<div class="text-xs font-weight-bold text-dark text-uppercase mb-1">We were missing you :) . After all it's your college</div>
			</div>
		</div>
		<div class="col-xl-6 ">
			<img src="img/working.png" class="welcome_img">
		</div>
		</div>
		</div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Jobs Applied for</div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Articles Posted</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">2</div>
                    </div>
                    <div class="col-auto">
