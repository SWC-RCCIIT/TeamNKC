...
<?php include_once('sidebar-principal-login.php')?>
...
<?php include_once('rightsidebar.php')?>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content" class="mt-4 pt-4 dashboard_body">
        ...
        <div class="container-fluid">
		 <!-- Page Heading -->
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="check-events.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Check Events</a>
          </div>
		  <!-- Welcome box -->
		...
		<div class="col-xl-6 ">
			<div>
			<div class="text-s font-weight-bold text-danger text-uppercase mb-1">Welcome Back Gautami Sinha</div>
			</div>
		</div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Number of Faculty Members</div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Waiting For Approval</div>
